    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-500 to-slate-100 py-8 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
          <h2 className="text-3xl font-bold text-gray-800 mb-2">Raise a Ticket</h2>
          <p className="text-gray-600 mb-6">
            Provide the details of the issue. Our team will reach out shortly after submission.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="4"
                placeholder="Add as many details as possible to help us resolve this quickly"
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  <span className="flex items-center gap-2">
                    ...
                    Preferred Visit Date <span className="text-gray-500 text-xs font-normal">(Optional)</span>
                  </span>
                </label>
                <input
                  type="date"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  <span className="flex items-center gap-2">
                    ...
                    Preferred Time Slot <span className="text-gray-500 text-xs font-normal">(Optional)</span>
                  </span>
                </label>
                <select
